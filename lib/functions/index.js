...
class Math {
    constructor(context) {
         ...
         * @type {()}
         */
        this.context.BUY = this.BUY.bind(this);
        this.context.SELL = this.SELL.bind(this);
        this.context.SHORT = this.SHORT.bind(this);
        this.context.COVER = this.COVER.bind(this);
        /**
         * 参数相关
         * @type {()}
         */
        this.context.PARAM = this.PARAM.bind(this);
    }
    ...
    BUY() {
        return BUY.apply(this.context, arguments)
    }

    SELL() {
        return SELL.apply(this.context, arguments)
    }

    SHORT() {
        return SHORT.apply(this.context, arguments)
    }

    COVER() {
        return COVER.apply(this.context, arguments)
    }

    PARAM() {
        return PARAM.apply(this.context, arguments)
    }
}
